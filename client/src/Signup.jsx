...
export default function Signup() {
  ...
  const handleSignup = async (e) => {
    ...
    try {
      ...
      // 2. Update their profile to include their Name
    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{ transform: "translateZ(30px)" }}>
            ...
            <h1 style={{ fontSize: "3.5rem", fontWeight: "800", lineHeight: "1.1", margin: "0 0 0.5rem 0" }}>
              Start Your <span style={{ background: "linear-gradient(90deg, #a78bfa, #ff3f81)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent" }}>Journey.</span>
            </h1>
            <div style={{ 
          ...
          <div style={{ 
            ...
            {features.map((f, i) => (
              <div key={i} onMouseEnter={() => setHoveredCube(i)} onMouseLeave={() => setHoveredCube(null)} style={{
                  cursor: "pointer", animation: `float 4s ease-in-out infinite`, animationDelay: `${i * 0.25}s`,
                ...
                <div className="glass-cube-shine" style={{
                    ...
                    boxShadow: hoveredCube === i ? "0 20px 40px -10px rgba(0,0,0,0.6), inset 1px 1px 2px rgba(255,255,255,0.4)" : "0 10px 30px -10px rgba(0,0,0,0.4), inset 1px 1px 2px rgba(255,255,255,0.2)",
                    transformStyle: "preserve-3d", transform: hoveredCube === i ? "rotateY(-12deg) rotateX(-4deg) translateZ(40px) scale(1.05)" : "rotateY(0deg) rotateX(0deg) translateZ(0px) scale(1)",
                    transition: "all 0.4s cubic-bezier(0.2, 0.8, 0.2, 1)"
                  }}>
                  <div style={{
                    transform: hoveredCube === i ? "translateZ(30px)" : "translateZ(0px)", transition: "transform 0.4s cubic-bezier(0.2, 0.8, 0.2, 1)", display: "flex", flexDirection: "column", alignItems: "center"
                  }}>
                    <div style={{
                      width: "44px", height: "44px", borderRadius: "12px", background: "rgba(255,63,129,0.1)", border: "1px solid rgba(255,63,129,0.25)",
                      color: "#ff7aab", display: "flex", alignItems: "center", justifyContent: "center", marginBottom: "12px",
                      boxShadow: hoveredCube === i ? "0 0 20px rgba(255,63,129,0.5)" : "none", transition: "box-shadow 0.3s ease"
                    }}>
                      {f.icon}
                    </div>
        ...
        <div className="middle-image-layer" style={{
          ...
          zIndex: 5, borderRadius: "28px", overflow: "hidden", boxShadow: "0 30px 60px rgba(0,0,0,0.7)"
        }}>
        ...
        <div onMouseEnter={() => setIsFormHovered(true)} onMouseLeave={() => setIsFormHovered(false)} style={{ flex: "0 1 420px", perspective: "1500px", zIndex: 10 }}>
          <div style={{
              ...
              transform: isFormHovered ? "rotateY(-5deg) rotateX(2deg) translateZ(20px) scale(1.02)" : "rotateY(-22deg) rotateX(4deg) translateZ(0px) scale(0.95)", 
            ...
            <form onSubmit={handleSignup}>
              ...
              {error && (
                <div style={{
                  ...
                  padding: "10px 14px", borderRadius: "10px", fontSize: "0.85rem", marginBottom: "1.25rem", textAlign: "center"
                }}>
                  {error}
                </div>
              )}
            ...
            <button
              ...
              style={{
                ...
                fontSize: "0.95rem", fontWeight: "600", color: "white", opacity: isLoading ? 0.7 : 1
              }}
            >
            ...
            <p style={{ textAlign: "center", marginTop: "2rem", color: "#9b9ba8", fontSize: "0.9rem" }}>
              ...
              {/* Ensure this link points back to your login route */}
              <Link to="/" style={{ color: "#ff7aab", textDecoration: "none", fontWeight: "700" }}>Login</Link>
            </p>
          </div>
        </div>
