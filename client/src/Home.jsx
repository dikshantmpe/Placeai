...
import { signInWithPopup, GoogleAuthProvider, GithubAuthProvider, onAuthStateChanged, setPersistence, browserLocalPersistence } from "firebase/auth";
...
export default function Home({ setUser }) {
  ...
  // UNIFIED OAUTH HANDLER - Pure Firebase (Google & GitHub)
  const handleOAuthLogin = async (providerName) => {
    try {
      ...
      console.error(`❌ ${providerName.toUpperCase()} LOGIN ERROR:`, err.message);
      alert(`${providerName} sign-in failed: ${err.message}`);
    }
  };
      ...
      <section className="hero">
        <div className="wrap hero-grid">
          <div>
            ...
            <div className="auth">
              <button className="google" onClick={() => handleOAuthLogin('google')}>
