...
export default function Home({ user }) {
    ...
    async function initVanta() {
      try {
        ...
        vantaEffect.current = window.VANTA.NET({
          ...
          scale: 1.0,
          scaleMobile: 1.0,
          color: 0xff3f81, // Pink nodes
          backgroundColor: 0x0a0812, // Deep dark background
          points: 11.0,
          maxDistance: 22.0,
          spacing: 17.0,
          showDots: true,
  ...
  const stats = [
    { title: "DSA Problems", value: "0", sub: "/ 450", trend: "+0 this week", icon: "💻", color: "rgba(239, 68, 68, 0.15)", stroke: "#ef4444" },
    { title: "Aptitude Quizzes", value: "0", sub: " Taken", trend: "+0 this week", icon: "🧠", color: "rgba(168, 85, 247, 0.15)", stroke: "#a855f7" },
    { title: "Mock Interviews", value: "0", sub: " Completed", trend: "+0 this week", icon: "🎤", color: "rgba(59, 130, 246, 0.15)", stroke: "#3b82f6" },
    { title: "Daily Streak", value: streak, sub: " Days", trend: "Keep it up! 🔥", icon: "🔥", color: "rgba(245, 158, 11, 0.15)", stroke: "#f59e0b" }
  ];
  ...
  return (
    <div style={{
      ...
      {/* Embedded CSS for the Grid and Glassmorphism */}
      <style>{`
        .bento-grid {
          display: grid;
      ...
      {/* Top Header */}
      <header style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "2rem", position: "relative", zIndex: 10 }}>
        <div>
        ...
        <div style={{
          ...
          <span style={{ fontSize: "0.85rem", fontWeight: "600", color: "#e2e8f0" }}>
            {user?.name?.split(" ")[0] || "Aditya"} • Ready to work
          </span>
        </div>
      </header>
        ...
        <div className="glass-panel bento-progress" style={{ gridColumn: "span 4", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", textAlign: "center" }}>
          ...
          <div style={{ position: "relative", width: "160px", height: "160px" }}>
            ...
            <svg viewBox="0 0 36 36" style={{ width: "100%", height: "100%", transform: "rotate(-90deg)" }}>
              ...
              />
              {/* Animated Progress Fill (Set to 35%) */}
              <path 
                d="M18 2.0845 a 15.9155 15.9155 0 0 1 0 31.831 a 15.9155 15.9155 0 0 1 0 -31.831" 
        ...
        {stats.map((stat, i) => (
          <div key={i} className="glass-panel bento-stat" style={{ gridColumn: "span 3", padding: "1.5rem" }}>
            ...
            <div style={{ color: "#10b981", fontSize: "0.8rem", fontWeight: "600", marginTop: "0.75rem", display: "flex", alignItems: "center", gap: "4px" }}>
               {stat.trend.includes('+') && <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="3"><path d="M12 19V5M5 12l7-7 7 7"/></svg>}
               {stat.trend}
            </div>
          </div>
        ))}
