  ...
  useEffect(() => {
    ...
    async function initVanta() {
      try {
        ...
        // Exact same configuration from your Login page
    ...
    <div className="home-container" style={{ position: "relative" }}>
      ...
      <div 
        style={{
          ...
          background: "radial-gradient(circle at 50% 50%, transparent 0%, rgba(12,10,20,0.65) 80%)"
        }} 
      />

      {/* All content must sit strictly above the background */}
