    ...
    >
        ...
        >
          <div
            style={{
              ...
              height: "500px",
              background:
                "radial-gradient(circle, rgba(220,38,38,0.35) 0%, transparent 65%)",
              borderRadius: "50%",
              pointerEvents: "none",
              zIndex: 0,
            }}
      ...
      >
        ...
        >
          ...
          >
            Access your personalized dashboard and continue your placement
            journey.
          </p>
          ...
          >
            <span style={{ color: "#333", fontSize: "11px" }}>
              Your data is <span style={{ color: "#22c55e" }}>secure</span> with
              us
            </span>
          </div>
        </div>
