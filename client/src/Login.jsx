...
export default function Login({ setUser }) {
  ...
  /* Mouse move for spotlight + subtle tilt */
  ...
  if (isCheckingAuth) {
    return (
      <div style={{
        ...
        fontFamily: "'Inter', sans-serif", color: "#fff", background: "#0c0a14"
      }}>
        ...
        <div style={{ position: "relative", zIndex: 10, textAlign: "center" }}>
          <div style={{
            ...
            border: "3px solid rgba(255,63,129,0.3)", borderTop: "3px solid #ff3f81",
    ...
    >
      ...
      <style>{`
        ...
        @keyframes pulse-glow {
          0%, 100% { box-shadow: 0 0 20px rgba(255,63,129,0.35); }
          50% { box-shadow: 0 0 30px rgba(255,63,129,0.55), 0 0 60px rgba(124,58,237,0.2); }
        }
        @keyframes reveal {
        ...
        .shimmer-text {
          background: linear-gradient(90deg, #a78bfa, #ff3f81, #a78bfa);
      ...
      {/* Film grain overlay */}
      <div style={{
        position: "absolute", inset: 0, zIndex: 2, pointerEvents: "none", opacity: 0.035,
      ...
      <div style={{
        ...
        background: `radial-gradient(500px circle at ${mouse.x}px ${mouse.y}px, rgba(255,63,129,0.06), transparent 40%)`,
        transition: "background 0.15s ease-out"
      }} />

      {/* Layout */}
      <div style={{
        position: "relative", zIndex: 10, width: "100%", maxWidth: "1350px",
        ...
        <div className="reveal" style={{
          ...
          <div style={{ transform: "translateZ(30px)" }}>
            ...
            <div style={{
              ...
              color: "#e2e8f0", fontSize: "0.9rem", marginTop: 8
            }}>
          ...
          <div style={{
            ...
            maxWidth: 420, alignItems: "start", transformStyle: "preserve-3d"
          }}>
            {features.map((f, i) => (
              <div
                key={i}
                ...
                style={{
                  ...
                  animationDelay: `${i * 0.25}s`, perspective: 1000,
                  marginTop: i % 2 !== 0 ? "3.5rem" : "0",
                  animationDelay: `${0.2 + i * 0.1}s`
                }}
              >
                <div className="cube-shine" style={{
                  background: "linear-gradient(135deg, rgba(255,255,255,0.08), rgba(255,255,255,0.02))",
                  backdropFilter: "blur(12px)", border: "1px solid rgba(255,255,255,0.15)",
                  borderRadius: 20, padding: "1.5rem 1rem", display: "flex", flexDirection: "column",
                  ...
                  <div style={{
                    transform: hoveredCube === i ? "translateZ(30px)" : "translateZ(0)",
        ...
        {/* MIDDLE IMAGE */}
        <div className="middle-image-layer reveal" style={{
          position: "absolute", left: "54%", top: "50%",
          transform: "translate(-50%, -50%)", width: 440, height: 640,
          ...
          <div style={{
            ...
            background: "linear-gradient(135deg, rgba(255,63,129,0.5), transparent, rgba(124,58,237,0.5))",
        ...
        {/* RIGHT FORM */}
        <div className="reveal" style={{
          flex: "0 1 420px", perspective: 1500, zIndex: 10, animationDelay: "0.4s"
        }}>
          <div
            onMouseEnter={() => setFormHover(true)}
            onMouseLeave={() => { setFormHover(false); setTilt({ x: 0, y: 0 }); }}
            ...
            style={{
              ...
              boxShadow: formHover
                ? "-30px 40px 60px -20px rgba(0,0,0,0.8), inset 1.5px 1.5px 3px rgba(255,255,255,0.2), 0 0 40px rgba(255,63,129,0.1)"
                : "-30px 40px 60px -20px rgba(0,0,0,0.8), inset 1.5px 1.5px 3px rgba(255,255,255,0.2)",
              padding: "3.5rem", transformStyle: "preserve-3d",
              transform: `rotateY(${tilt.y}deg) rotateX(${tilt.x}deg) translateZ(${formHover ? 20 : 0}px) scale(${formHover ? 1.01 : 0.95})`,
          ...
          >
            ...
            <div style={{
              ...
              WebkitMask: "linear-gradient(#fff 0 0) content-box, linear-gradient(#fff 0 0)",
              WebkitMaskComposite: "xor", maskComposite: "exclude",
              opacity: formHover ? 0.8 : 0.3, transition: "opacity 0.4s ease", pointerEvents: "none"
            }} />
            ...
            <form onSubmit={handleLogin} autoComplete="off">
              ...
              <div className={`glass-input ${focusedField === "email" ? "focused" : ""}`} style={{
                borderRadius: 14, marginBottom: "1.25rem", display: "flex", alignItems: "center", padding: "0 16px"
              }}>
                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#ff7aab" strokeWidth="2" style={{ flexShrink: 0, marginRight: 12 }}>
                  <path d="M3 7l9 6 9-6" /><rect x="3" y="5" width="18" height="14" rx="2" />
                </svg>
                <input
                  type="email" value={email} onChange={(e) => setEmail(e.target.value)}
                  onFocus={() => setFocusedField("email")} onBlur={() => setFocusedField(null)}
                  placeholder="Email address" autoComplete="new-email" spellCheck="false"
              ...
              <div className={`glass-input ${focusedField === "password" ? "focused" : ""}`} style={{
                borderRadius: 14, marginBottom: "1rem", display: "flex", alignItems: "center", padding: "0 16px"
              }}>
                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#ff7aab" strokeWidth="2" style={{ flexShrink: 0, marginRight: 12 }}>
                ...
                <input
                  ...
                  placeholder="Password" autoComplete="new-password" spellCheck="false"
                  style={{ flex: 1, background: "transparent", border: "none", outline: "none", color: "white", fontSize: "1rem", padding: "16px 0" }}
                  required
                />
                <button type="button" onClick={() => setShowPassword(!showPassword)} style={{
                  ...
                  {showPassword ? (
                    ...
                    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                      ...
                      <path d="M14.12 14.12A3 3 0 1 1 9.88 9.88" /><path d="M1 1l22 22" />
                    </svg>
                  )}
                </button>
              </div>
              ...
              <div style={{ textAlign: "right", marginBottom: "1.75rem" }}>
                <a href="#" style={{ color: "#ff7aab", fontSize: "0.85rem", textDecoration: "none", fontWeight: 600 }}>
                  Forgot Password?
                </a>
              </div>

              <button
                type="submit" disabled={isLoading} className="shine-btn"
                style={{
                  width: "100%", padding: 16, borderRadius: 14, border: "none",
                  cursor: isLoading ? "not-allowed" : "pointer",
                  background: "linear-gradient(90deg, #7c3aed, #ff3f81)",
                  color: "white", fontSize: "1.05rem", fontWeight: 700,
                  animation: isLoading ? "none" : "pulse-glow 3s ease-in-out infinite",
                  transition: "transform 0.2s ease, filter 0.2s ease",
                  opacity: isLoading ? 0.7 : 1,
                  transform: formHover ? "translateY(-1px)" : "translateY(0)"
                }}
              >
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 14, margin: "2rem 0" }}>
              ...
              <span style={{ color: "#6b6b78", fontSize: "0.75rem", textTransform: "uppercase", letterSpacing: 1 }}>or continue with</span>
              <div style={{ flex: 1, height: 1, background: "rgba(255,255,255,0.1)" }} />
            </div>
            ...
            <button
              ...
              style={{
                width: "100%", padding: 14, borderRadius: 14, display: "flex",
