...
const moreProblems = [
  ...
  },
  {
    ...
    testCases: [
      { input: { operations: ["insert", "search", "search", "startsWith", "insert", "search"], args: [["apple"], ["apple"], ["app"], ["app"], ["app"], ["app"]] }, expected: [null, true, false, true, null, true] }
    ]
  },
  {
  ...
  },
  {
    ...
    testCases: [
      { input: { heights: [[1, 2, 2, 3, 5], [3, 2, 3, 4, 4], [2, 4, 5, 3, 1], [6, 7, 1, 4, 5], [5, 1, 1, 2, 4]] }, expected: [[0, 4], [1, 3], [1, 4], [2, 2], [2, 3], [2, 4], [3, 0], [3, 1], [4, 0]] },
...
async function seedProblems() {
  try {
    ...
    console.log("🗑️ Cleared old problems without descriptions/test cases");

    const result = await Problem.insertMany([...problemsData, ...moreProblems]);

    console.log(`✅ Successfully seeded ${result.length} problems with full Test Cases!`);
